...
async def process_note_text(message: types.Message, state: FSMContext):
    """Обрабатывает текст заметки и запрашивает часы"""
...
# Остальные хендлеры (list_notes, delete_note, view_note и т.д.) остаются без изменений
# ...
        ...
        for note in notes_to_check:
            ...
            if not note['reminder_24h_sent'] and time_diff <= timedelta(days=1) and time_diff > timedelta(hours=1):
                try:
                    ...
                    logging.error(f"Ошибка отправки 24h напоминания: {e}")
            ...
            # Напоминание за 1 час
                ...
                try:
                    ...
                    logging.error(f"Ошибка отправки 1h напоминания: {e}")
